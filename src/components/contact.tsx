...
import { TextIcon as ChatCircleText, MailOpenIcon as Envelope, UserCircle } from "lucide-react"
                                ...
                                <FormItem>
                                    <FormControl>
                                        <div className="relative">
                                            <UserCircle className="absolute left-3 top-1/2 -translate-y-1/2 text-[#6a6a6a] h-5 w-5" />
                                            <Input
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormControl>
                                        <div className="relative">
                                            <Envelope className="absolute left-3 top-1/2 -translate-y-1/2 text-[#6a6a6a] h-5 w-5" />
                                            <Input
                        ...
                        <FormField
                            ...
                            render={({ field }) => (
                                <FormItem>
                                    <FormControl>
                                        <div className="relative">
                                            <ChatCircleText className="absolute left-3 top-1/2 -translate-y-1/2 text-[#6a6a6a] h-5 w-5 opacity-100" />
                                            <Input
